...
let actionMap = {
  init: {
    ...
    usages: ['lerna-tuya init templateName projectName']
  },
  config: {
    alias: 'cfg',
    description: 'config .lernaya',
    usages: ['lerna-tuya config set <k> <v>', 'lerna-tuya config get <k>', 'lerna-tuya config remove <k>']
  }
  // other commands
};
